...
using AlexaAppKit.Speechlet;
using AlexaAppKit.Slu;

namespace AlexaAppKit.Json
{
    public class SpeechletRequestEnvelope
    {
        ...
        public static SpeechletRequestEnvelope FromJson(JObject json) {
            ...
            switch (requestType) {
                case "LaunchRequest":
                    request = new LaunchRequest(requestId);
                    break;
                case "IntentRequest":
                    request = new IntentRequest(requestId, Intent.FromJson(requestJson.Value<JObject>("intent")));
                    break;
                case "SessionStartedRequest":
                    request = new SessionStartedRequest(requestId);
                    break;
                case "SessionEndedRequest":
                    ...
                    request = new SessionEndedRequest(requestId, reason);
                    break;
                default:
